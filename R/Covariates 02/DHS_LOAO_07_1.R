...
pse.dat.in = pse.dat.fit[-district.ind,]
pse.pred = pse.dat.fit[district.ind,]
...
saveRDS(both.pred, file = paste0("Results/LOO_Results/DHS/Both_pred_values_ID_",ID.vec[i],"_ind_",i,".rds"))
saveRDS(dhs.pred, file = paste0("Results/LOO_Results/DHS/DHS_pred_values_ID_",ID.vec[i],"_ind_",i,".rds"))
saveRDS(aux.pred, file = paste0("Results/LOO_Results/DHS/Aux_pred_values_ID_",ID.vec[i],"_ind_",i,".rds"))